...
const Contact = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.consent) {
      toast.error("Veuillez accepter l'utilisation de vos données");
      return;
    }
    ...
    try {
      ...
      await api.post('/contact-messages/', messageData);
        ...
        <div className="animate-fade-in space-y-8">
          ...
          <div className="text-center max-w-2xl mx-auto">
            ...
            <p className="text-muted-foreground text-lg">
              Une question sur Yoonu-Tabax ? Notre équipe est là pour vous aider
            </p>
          </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        contact@yoonu-tabax.fr
                      </p>
                      <p className="text-sm text-muted-foreground">
                        support@yoonu-tabax.fr
                      </p>
                    </div>
                  </div>
                </CardContent>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="flex items-center gap-2">
                      <input
                        ...
                        onChange={handleChange}
                        required
                        aria-label="J'accepte que mes données soient utilisées pour traiter ma demande"
          ...
          <Card className="max-w-6xl mx-auto">
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {[
                  {
                    q: "Comment puis-je obtenir une démo de Yoonu-Tabax ?",
                    a: "Contactez-nous via le formulaire ci-dessus ou par téléphone pour planifier une démonstration personnalisée.",
                  },
                  {
                    q: "Yoonu-Tabax est-il adapté aux petits projets ?",
                    a: "Oui, Yoonu-Tabax s'adapte à tous types de projets, des plus petits aux plus grands.",
                  },
                  {
